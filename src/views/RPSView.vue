...
let player2 = prompt("Rock, paper, or scissors?").toLowerCase();
...
<!--</template>-->
<template>
  <h1 v-if="(player2 === 'rock' && player1 === 'rock') || (player2 === 'scissors' && player1 === 'scissors') || (player2 === 'paper' && player1 === 'paper')">Player 1: {{player1}}, Player 2: {{player2}}: It's a tie!</h1>
  <h1 v-else-if="(player2 === 'rock' && player1 === 'scissors') || (player2 === 'scissors' && player1 === 'paper') || (player2 === 'paper' && player1 === 'rock')">Player 1: {{player1}}, Player 2: {{player2}}: You win!</h1>
  <h1 v-else-if="(player2 === 'rock' && player1 === 'paper') || (player2 === 'scissors' && player1 === 'rock') || (player2 === 'paper' && player1 === 'scissors')">Player 1: {{player1}}, Player 2: {{player2}}: You lose!</h1>
</template>
